...
echo ""
wget https://github.com/NewCapital/TWINS-Core/releases/download/twins_v3.2.2.2/twins-3.2.2.2-MN-x86_64-linux-gnu.tar.gz.tgz
tar -xvzf twins-3.2.2.2-MN-x86_64-linux-gnu.tar.gz.tgz
echo ""
